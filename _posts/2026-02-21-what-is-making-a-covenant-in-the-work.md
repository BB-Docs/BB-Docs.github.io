...
subtitle: "World Kabbalah Convention · Rabash, Article No. 31, 1987 · Lesson 6 of the World Kabbalah Convention (Feb 19–21, 2026), led by Rav Laitman"
date: 2026-02-21
---
...
## Part 1 — Making a Covenant Means Building the Creator

Rav Laitman opens by naming exactly what stands before the group: not an agreement between people, but the construction of a vessel for the Creator's own revelation.

> "What does it mean to make a covenant where we commit to behave this way with one another in order to stabilize between us a place for the revelation of the Creator? ... We are building Him. You have made Me, it's written."

He frames the whole of "the Creator's work" as building one quality — bestowal — entirely on one's own: "It's entirely bestowal, which is what is called the Creator. This is how we reveal Him, establish Him, make a room for Him to exist between us. We build Him." Everything the group has been through, he says — the shattering, the Reshimot (records) carried forward from it, the First and Second Temple — was preparation for a single action being performed now: building the actual connection on top of all of it.

Our direction, he adds, runs opposite to the world's: rather than running from what's difficult, "we receive everything that's being revealed in each and every one of us... so that from that, we will build the correct relations in which the Creator can be revealed" — turning whatever surfaces into material for the network of connection, the Kli, itself.

---

## Part 2 — The Covenant as a Clash Between Two Opposite Forces

Rav Laitman describes the covenant not as harmony but as confrontation: a person is caught between two genuinely opposite forces — one rooted in the Creator, the other the evil inclination — and the work is not to dissolve the clash but to hold both in the same place at once.

> "Our root is completely from the Creator, and all the rest of this evil inclination is the opposite form to it... we specifically bring them into a clash between them. Through this clash... we will come to build the correction, and darkness shall shine as light, and we will all be revived."

Nothing here needs to be invented, he notes — "it already exists, all these states already exist, we just need to try and implement them, to give life to them, to reveal them."

---

## Part 3 — Arvut in the Ten: How Mutual Care Cancels Fear

Commenting on a clip from the Chile congress, Rav Laitman lays out what a covenant of Arvut (mutual guarantee) actually does for a person inside a Ten: each becomes a guarantor for the others, and this — not willpower — is what frees a person from private anxiety.

> "If I'm in a Ten and all the friends in the Ten are showing me that they care for me, they automatically cancel my desire from being worried about myself. Like it or not, I want it or not... I'm like a little bunny trembling constantly in fear. However, if my friends are thinking about me, they neutralize completely my fear, my anxiety in any possible way. Even if I don't want."

He's explicit that this isn't a one-time condition; love left unattended "chills down" and must be renewed constantly:
...
## Part 5 — One Degree, Different Intensity

Returning after the workshop, Rav Laitman stresses that a covenant made once, verbally or in writing, changes nothing by itself — corporeally or spiritually, "we know how these things don't obligate a person in any way." What sustains it is repetition at every stage of ascent:

> "In all the degrees, in each and every point where we rise, we perform the same degrees... The difference is only in the conditions that we make, but Ten Sefirot that we build are Ten Sefirot in each and every state... only the different stages of intensity."

He illustrates this with Abraham, ninety years old and still being asked to take on a new covenant — a friend's objection ("you're ready, well, what are you going to sorrow yourself?") answered by the Creator telling him to rise specifically above that reasoning. Rav Laitman applies the same structure to himself: the same self-doubting questions return "with a greater burdening each time," and the only way through is to erase the ego rather than argue with it:

> "If we don't rise above this, above where a person erases his ego, and raises only this point above him, he has no answer, and no chance, no possibility to reach something."
...
His answer is to stop treating it as a problem to be settled and instead keep correcting the way it's seen: everything — the friends, the light, the Creator — is one thing, scattered only in a person's own eyes.

> "I bring it back to one, by constantly working on the correct perception of reality, and by that, I keep the covenant, as Israel, the Torah, and the Creator are One."
